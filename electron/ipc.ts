...
export function registerIpc(deps: IpcDeps): void {
  ...
  ipcMain.handle('settings:set', (_e, patch: Record<string, unknown>) => {
    const allowed: (keyof ReturnType<Settings['get']>)[] = [
      'density', 'checkboxShape', 'projectName', 'seedLoaded', 'viewPrefs',
      'localApiEnabled', 'localApiAllowWrites', 'localApiPort',
      'autoBackup', 'backupIntervalMin', 'backupRetention',
    ];
